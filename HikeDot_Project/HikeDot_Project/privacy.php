...
<head>
<title>HikeDot</title>
	<link rel="icon" href="img/hikedot.png"/>
...
<body>
	<div id="header">
	<img src="img/hikedot.png">
		<label><em>HikeDot</em></label>
			<ul>
...
<div id="container">
	<div class="nav">	
		...
		<div id="content">
			<legend><h3>Privacy Policy</h3></legend>
				<p>The HikeDot Incorporated respect the privacy of the visitors
					to the HikeDot.com website and the local websites connected with it, and take great care to protect your 
			...
			<hr>
				<h4>Protection of visitors information</h4>
					<p>In order to protect the information you provide to us by visiting our website we have implemented various
						...
						risk that third parties may intercept and use that information. While HikeDot strives to protect its user's 
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Mariam Zenaishvili</p>
		</div>
			
			<div id="foot">
				<h4 style="margin-left: 30px;">Links</h4>
					<ul>
